...
for(const name of ['index.html','src','app','assistant','intent','design-system','business-world-model','public','references','.nojekyll'])await cp(path.join(root,name),path.join(out,name),{recursive:true});
