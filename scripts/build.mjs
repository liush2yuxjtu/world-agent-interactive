...
for(const name of ['index.html','ui.html','src','app','product-demo','eli5','prototype','assistant','intent','design-system','business-world-model','public','references','.nojekyll'])await cp(path.join(root,name),path.join(out,name),{recursive:true});
